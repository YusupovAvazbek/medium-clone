package com.example.mediumclone.message;

public class AppStatusCodes {
    public static final Integer NOT_AUTHENTICATED = -4;
    public static final Integer ALREADY_EXISTS_ERROR_CODE = -3;
    ...
    public static final Integer NULL_VALUE_CODE = 3;
}
